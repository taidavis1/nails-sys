...
const IconAddServiceOutline = ({ nameIcon, activeNameIcon, sizeIcon, theme }) => {
    const styles = {
        st0: {
            fill: 'none',
    ...
    return (
        <Svg id="icon-add-services-outline" viewBox={`0 0 32 32`} width={sizeIcon || 32} height={sizeIcon || 32}>
